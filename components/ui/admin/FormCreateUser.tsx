...
export default function FormCreateUser(prop: FormCreateUserProps) {
    ...
    const disableSubmit = !data.associationId || !data.dni || !data.name || !data.email

    const DataFormScheme = z.object({
        username: z.string(),
        name: z.string(),
        dni: z.string(),
        email: z.string(),
    ...
    const handleDni = (data: any) => {
        setData({ ...data, dni: data })
    }
    const handleAssociation = (data: any) => {
        setData({ ...data, associationId: data })
    }
    const handleEmail = (data: any) => {
        setData({ ...data, email: data })
    }
    const handleSubmit = () => {
